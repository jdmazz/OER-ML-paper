...
for three electrochemical descriptors: Tafel slope, overpotential at 10 and 5 mA/cm²
(η₁₀ and η₅), and the full shape of the differential Tafel curve (dJ/dV).

## Background

The dataset was generated with a custom high-throughput Scanning Electrochemical Cell
(HT-SEC) using 0.5 mL of 0.1 M H₂SO₄ electrolyte.  Cyclic voltammetry (CV) was
recorded for a combinatorial library of {Ir, Pt, Au, Pd} quaternary alloys; only
the 5th forward scan is used for analysis to ensure steady-state conditions. Durability/Corrosion data is provided in external/.
